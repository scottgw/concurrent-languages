...
class testMain(unittest.TestCase):
  ...
  def testCreateInputs(self):
    ...
    main.file_exists('winnow_10_15_30_40.in').AndReturn(False)
    main.file_exists('winnow_10_15_30_40.out').AndReturn(False)
    ...
    main.system('cp thresh_10_15_30.out winnow_10_15_30_40.in')
    main.append_to_file('thresh_10_15_30.in', '30\n')
    main.system('cp randmat_10_15_20.out winnow_10_15_30_40.in')
    main.read_from_file_skipping_first_line(
        'thresh_10_15_30.out').AndReturn('thresh_out')
    main.append_to_file('winnow_10_15_30_40.in', '\nthresh_out\n40\n')
    main.system(
        'dir_winnow/main < winnow_10_15_30_40.in > winnow_10_15_30_40.out')
    main.system('cp winnow_10_15_30_40.out outer_40.in')
    main.system(
  ...
  def testCreateInputsFileExists(self):
    ...
    main.file_exists('winnow_10_15_30_40.in').AndReturn(True)
    main.file_exists('winnow_10_15_30_40.out').AndReturn(True)
