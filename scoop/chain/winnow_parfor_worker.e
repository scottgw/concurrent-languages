...
feature
  ...
  put(an_aggregator: separate WINNOW_PARFOR_AGGREGATOR;
      value: separate TUPLE[INTEGER, INTEGER, INTEGER])
  do
    an_aggregator.put(value)
  end

  done(an_aggregator: separate WINNOW_PARFOR_AGGREGATOR)
  do
    an_aggregator.done
  end
...
feature {NONE}
  ...
  aggregator: separate WINNOW_PARFOR_AGGREGATOR
